...
To install this Home Assistant add-on you need to add the rtl_433 add-on repository first:
 ...
 3. Enter https://github.com/baronhoot/rtl_433-hass-addons in the "Add repository" field.
...
```
docker run -e MQTT_HOST=mqtt.example.com -e MQTT_USERNAME=username -e MQTT_PASSWORD=password ghcr.io/baronhoot/rtl_433-hass-addons-rtl_433_mqtt_autodiscovery-amd64
```
...
services:
  rtl_433_autodiscovery:
    ...
    image: ghcr.io/baronhoot/rtl_433-hass-addons-rtl_433_mqtt_autodiscovery-amd64 # On Raspberry Pi replace `amd64` with the appropriate architecture.
    environment:
